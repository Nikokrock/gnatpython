...
This package provides a single class called OptFileParse which process
the test.opt files. These files are used mainly to tweak tests depending
on the context.
"""
...
class OptFileParse(object):
    ...
    def __init__(self, system_tags, filename):
        ...
        """
        if isinstance(system_tags, str) or isinstance(system_tags, unicode):
